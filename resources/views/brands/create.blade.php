...
@section('content')
    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <h2 class="text-title-md2 font-bold text-black dark:text-white">Agregar Marca</h2>
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="font-medium text-primary">Agregar Marca</li>
            </ol>
        </nav>
    </div>
    <!-- Breadcrumb End -->
            ...
            <form action="{{ route('brands.store') }}" method="POST">
                ...
                <div class="p-6.5">
                    <div class="mb-4.5">
                        ...
                        <input type="text" name="name" id="name" required placeholder="Nombre de la marca"
